...
import { Layout, Button, Avatar, Input, Row, Col, theme, Menu, Popover, Modal } from "antd";
...
const AdminLayout = () => {
  ...
  const handleLogout = () => {
    ...
    Modal.confirm({
      title: <div style={{ textAlign: 'center', fontWeight: 600 }}>
        <span style={{ fontSize: 22, color: '#faad14', marginRight: 8 }}>⚠️</span>Chiqishni tasdiqlang
      </div>,
      content: <div style={{ textAlign: 'center', fontSize: 16, marginTop: 8 }}>
        Haqiqatan ham tizimdan chiqmoqchimisiz?
      </div>,
      okText: "Ha, chiqaman",
      cancelText: "Bekor qilish",
      okButtonProps: { danger: true, style: { float: 'left' } },
      cancelButtonProps: { type: 'primary', style: { float: 'right' } },
      centered: true,
      icon: null,
      onOk: () => {
        logOut();
