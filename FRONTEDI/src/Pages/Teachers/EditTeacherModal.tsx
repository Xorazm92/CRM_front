// Converted from EditTeacherModal.jsx to EditTeacherModal.tsx with full TypeScript support
...
const EditTeacherModal: React.FC<EditTeacherModalProps> = ({ isOpen, onClose, teacher, onTeacherEdited }) => {
  const [form] = Form.useForm<EditTeacherForm>();
  ...
  const handleFinish = async (values: EditTeacherForm) => {
    setLoading(true);
    try {
