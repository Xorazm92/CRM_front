...
var Icon2 = React835.forwardRef(function(props, ref) {
  ...
  var iconRef = React835.useRef();
  var mergedRef = useComposeRef(iconRef, ref);
  warning(Boolean(Component || children), "Should have `component` prop or `children`.");
  useInsertStyles(iconRef);
  var _React$useContext = React835.useContext(Context_default), _React$useContext$pre = _React$useContext.prefixCls, prefixCls = _React$useContext$pre === void 0 ? "anticon" : _React$useContext$pre, rootClassName = _React$useContext.rootClassName;
  ...
  var renderInnerNode = function renderInnerNode2() {
    if (Component) {
      return React835.createElement(Component, innerSvgProps, children);
    }
    if (children) {
      warning(Boolean(viewBox) || React835.Children.count(children) === 1 && React835.isValidElement(children) && React835.Children.only(children).type === "use", "Make sure that you provide correct `viewBox` prop (default `0 0 1024 1024`) to the icon.");
      return React835.createElement("svg", _extends({}, innerSvgProps, {
        viewBox
      }), children);
    }
    return null;
  ...
  return React835.createElement("span", _extends({
    role: "img"
  }, restProps, {
    ref: mergedRef,
    tabIndex: iconTabIndex,
...
function create() {
  ...
  var Iconfont = React836.forwardRef(function(props, ref) {
    ...
    return React836.createElement(Icon_default, _extends({}, extraCommonProps, restProps, {
      ref
    }), content);
  });
